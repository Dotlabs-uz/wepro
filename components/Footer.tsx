...
const Footer: React.FC<FooterProps> = () => {
   return (
      <footer className="custom-container max-sm:px-0">
         <div className="mb-12 pt-16 max-lg:pt-10 max-md:pt-7 px-28 max-3xl:px-20 max-2xl:px-10 max-lg:px-4 rounded-2xl shadow-[0px_5px_20px_0px_#15151526] bg-[#F5F5F5]">
            ...
            <div className="grid grid-cols-4 max-3xl:grid-cols-3 max-lg:grid-cols-2 max-[429px]:grid-cols-1 gap-5 py-16 max-lg:py-10 max-md:py-7 border-t border-[#1515151a]">
               <div className="max-3xl:col-span-3 max-lg:col-span-1 max-3xl:mb-10 max-sm:m-0">
               ...
               <div className="">
                  <h3 className="text-lg font-bold mb-5 max-md:mb-2">Контакты:</h3>
                  <ul className="text-[#A3A2AB] font-bold">
               ...
               <div className="">
                  <h3 className="text-lg font-bold mb-5 max-md:mb-2">Социальные сети:</h3>
                  <ul className="text-[#A3A2AB] font-bold">
                     <li className="mb-1">

      ...
      <>
         <section>
            <div className="custom-container">
               <div className="flex items-center justify-between mt-12 mb-28 mx-28 max-2xl:mx-20 max-xl:mx-10 max-lg:mx-0">
                  <div className="w-1/2">
                     <h2 className="max-w-sm text-5xl max-xl:text-4xl font-bold leading-normal mb-7 max-2xl:mb-4">
                        Отзывы о курсах Wepro
                     </h2>
                  ...
                  <div className="max-w-md max-2xl:max-w-xs">
                     <Image
